...
public class CameraMovement : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        dir = new Vector3(5f, 5f, 0);//assign value to the distance between the maincamera and the target
    ...
    void Update()
    {
        ...
        //We are in editor
        if (Application.isEditor || Application.platform == RuntimePlatform.WindowsPlayer || Application.platform == RuntimePlatform.WebGLPlayer || Application.platform == RuntimePlatform.CloudRendering )
        {
            EditorCameraInput();
        }
